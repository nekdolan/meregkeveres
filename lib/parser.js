...
(function() {
  var cacheOverride, calculateCost, calculateDifficulty, calculateSpecialDifficulty, costMultipliers, difficultyModifiers, exports, getDifficultyForModifier, getLevelData, getPoisonLevelData, getPosisonLevels, key, provider, specialConditions, specialDifficultyModifiers, t, translate, valueProviders,
  ...
  calculateCost = function(modifiers) {
    ...
    durationCost = data.idotartam === 'maradando' ? 3 : 1;
  ...
  valueProviders = {
    tobb: function() {
      return 30 * this.getNumber(t('tobb'));
    },
    fp_vesztes: function() {
      return 2 * this.getNumber(t('fp_vesztes'));
    }
  };
  ...
  getDifficultyForModifier = function(type, name, changed) {
    ...
    if ((type === 'eros' || type === 'gyenge')) {
      ...
      difficulty = (ref1 = difficultyModifiers[type]) != null ? ref1[name] : void 0;
    }
  ...
  calculateSpecialDifficulty = function(modifiers) {
    ...
    ref = getPoisonLevelData(data), eros = ref.eros, gyenge = ref.gyenge, fo = ref.fo;
    return _(specialConditions).reduce((function(res, fn) {
      return res + fn(eros, gyenge, fo, data);
    }), 0);
  };
