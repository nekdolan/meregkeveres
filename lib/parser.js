...
(function() {
  ...
  valueDifficultyCalculator = {
    ...
    fp_vesztes_gyenge: function(val, eros) {
      if (eros === 'fp_vesztes') {
        return val;
      } else {
        return val * 2;
  ...
  getDifficultyForModifier = function(type, name, changed, charLevel, eros) {
  ...
  calculateDifficulty = function(modifiers, changed, charLevel, eros) {
    return calculateSkillModifiers(modifiers) + calculateSpecialDifficulty(modifiers) + _(modifiers).map(function(modifier) {
      return getDifficultyForModifier(modifier.name, modifier.value, changed, charLevel, eros);
