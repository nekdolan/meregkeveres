...
(function() {
  ...
  calculateCost = function(modifiers) {
    ...
    durationCost = data.idotartam === 'maradando' && eros.effectType !== 'halal' ? 4 : 1;
  ...
  getDifficultyForModifier = function(type, name, changed, charLevel) {
  ...
  calculateDifficulty = function(modifiers, changed, charLevel) {
    return calculateSkillModifiers(modifiers) + calculateSpecialDifficulty(modifiers) + _(modifiers).map(function(modifier) {
      return getDifficultyForModifier(modifier.name, modifier.value, changed, charLevel);
