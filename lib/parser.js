...
(function() {
  var alchemy, alchemyModifiers, cacheOverride, calculateCost, calculateDifficulty, calculateNegativeDifficulty, calculateSkillModifiers, calculateSpecialDifficulty, checkForError, costMultipliers, difficultyModifiers, errorMessages, exports, getDifficultyForModifier, getLevelData, getModifierValue, getPoisonLevelData, getPosisonLevels, key, negativeDifficultyModifiers, provider, sendError, sendValue, specialConditions, specialDifficultyModifiers, t, testAlchemy, translate, valueDifficultyCalculator, valueProviders,
  ...
  testAlchemy = function(supplyType, poisonType, alchemyLevel) {
    ...
    if (availableAlchemyLevel === -1) {
      availableAlchemyLevel = 0;
    }
